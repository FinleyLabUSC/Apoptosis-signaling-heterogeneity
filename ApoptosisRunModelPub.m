...
numCells = 10000; 
%% Finding and Varying Non-Zero Initial Protein Amounts with Uniform Distribution OR Normal Distribution (Supplemental Figures)
% Comment entire section for Figure 2
...
p(27) = 1e-6; % ligand-receptor association 
p(28) = 1.2e-2; % ligand-receptor dissociation %assumption -change

% p29 based on FasL signaling from Wu and Finley 2017
p(29) = 8.04e-5; % ligand-receptor complex signaling strength  

p(30) = 0; % receptor production

% p31 and p32 based on FasL signaling from Wu and Finley 2017
p(31) = 1.3e-3; % receptor degredation %assumption  -change    
p(32) = 4.67e-6;%receptor-ligand complex internalization -change    
